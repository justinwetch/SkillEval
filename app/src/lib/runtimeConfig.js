export const DEFAULT_RUNTIME_CONFIG = Object.freeze({
  ...
  runHistoryServerUrl: 'http://localhost:3001',
})
...
export function getRuntimeConfig(env = import.meta.env) {
  return {
    ...
    runHistoryServerUrl: env?.VITE_RUN_HISTORY_SERVER_URL || env?.VITE_SCREENSHOT_SERVER_URL || DEFAULT_RUNTIME_CONFIG.runHistoryServerUrl,
  }
}
